...
/////////////////
const BotName = 'PAITONN BOT☄'; 
const instagram = 'https://instagram.com/r1yannnn'; 
const telegram = 'https://t.me/paitonnn'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCPgQ_OQbf01MVVoCVpI6gpg';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@r1yannnn')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@r1yannnn`)
})
